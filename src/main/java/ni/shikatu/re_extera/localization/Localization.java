...
public class Localization {
    ...
    public static String EDIT_HISTORY_MENU_BUTTON;
    public static String EDIT_HISTORY_STORAGE_USED;
    public static String EDIT_HISTORY_TRACKED_MESSAGES;
    public static String EDIT_HISTORY_INLINE_LABEL;
    public static String CLEAR_EDIT_HISTORY;
    public static String CLEAR_EDIT_HISTORY_CONFIRM;
    public static String SAVE_SELF_EDITS;
    ...
    public static void updateStrings() {
        ...
        if ("ru".equals(currentLang)) {
            ...
            EDIT_HISTORY_MENU_BUTTON = "История правок";
            EDIT_HISTORY_STORAGE_USED = "Занято места";
            EDIT_HISTORY_TRACKED_MESSAGES = "Отслеживается сообщений";
            EDIT_HISTORY_INLINE_LABEL = "Изменено с";
            CLEAR_EDIT_HISTORY = "Очистить историю правок";
            CLEAR_EDIT_HISTORY_CONFIRM = "Удалить всю сохранённую историю изменений сообщений? Это действие необратимо.";
            SAVE_SELF_EDITS = "Сохранять и свои правки";
            ...
            EDIT_HISTORY_MENU_BUTTON = "Історія редагувань";
            EDIT_HISTORY_STORAGE_USED = "Зайнято місця";
            EDIT_HISTORY_TRACKED_MESSAGES = "Відстежується повідомлень";
            EDIT_HISTORY_INLINE_LABEL = "Змінено з";
            CLEAR_EDIT_HISTORY = "Очистити історію редагувань";
            CLEAR_EDIT_HISTORY_CONFIRM = "Видалити всю збережену історію змін повідомлень? Цю дію неможливо скасувати.";
            SAVE_SELF_EDITS = "Зберігати і свої правки";
        ...
        EDIT_HISTORY_MENU_BUTTON = "Edit History";
        EDIT_HISTORY_STORAGE_USED = "Storage used";
        EDIT_HISTORY_TRACKED_MESSAGES = "Tracked messages";
        EDIT_HISTORY_INLINE_LABEL = "Edited from";
        CLEAR_EDIT_HISTORY = "Clear edit history";
        CLEAR_EDIT_HISTORY_CONFIRM = "Delete all saved message edit history? This action cannot be undone.";
        SAVE_SELF_EDITS = "Also save my own edits";
